        ...
        {currentStep === 1 && (
          <div className="max-w-3xl mx-auto w-full">
            <div className="text-center mb-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Welcome to Your Health Data Manager</h2>
              <p className="text-lg text-gray-600 mb-6">
                Your personal health data assistant that keeps your information secure, private, and always accessible.
              </p>
            </div>
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-blue-800">
                    This app is designed with privacy at its core. Your health data never leaves your device 
                    unless you explicitly choose to share it. We use local storage and encryption to keep 
          ...
          <div className="max-w-2xl mx-auto w-full">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Let's set up your basic health information to personalize your experience. 
            ...
            <div className="bg-yellow-50 border border-yellow-100 rounded-lg p-4 mt-6">
              <div className="flex">
                ...
                <p className="text-sm text-yellow-700">
                  This information helps tailor health insights and recommendations. You can update or remove it anytime from your profile settings.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="pt-4 border-t border-gray-200">
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      <BackupOption 
                        ...
                        onClick={() => setPrivacyPreferences({...privacyPreferences, backupFrequency: 'daily'})}
                      />
                      <BackupOption 
                        label="Weekly" 
                        isSelected={privacyPreferences.backupFrequency === 'weekly'}
                        onClick={() => setPrivacyPreferences({...privacyPreferences, backupFrequency: 'weekly'})}
                      />
                      <BackupOption 
                        label="Monthly" 
                        isSelected={privacyPreferences.backupFrequency === 'monthly'}
                        onClick={() => setPrivacyPreferences({...privacyPreferences, backupFrequency: 'monthly'})}
                      />
                      <BackupOption 
                        label="Manual" 
                        isSelected={privacyPreferences.backupFrequency === 'manual'}
                        onClick={() => setPrivacyPreferences({...privacyPreferences, backupFrequency: 'manual'})}
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-green-50 border border-green-100 rounded-lg p-4 mt-6">
              <div className="flex">
                ...
                <p className="text-sm text-green-700">
                  Your privacy is our priority. All settings can be adjusted anytime from the Privacy & Security section in your profile.
                </p>
              </div>
            </div>
          </div>
        ...
        {currentStep === 4 && (
          <div className="max-w-3xl mx-auto w-full">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Get started with your existing health records or start fresh. All imports are processed locally on your device.
              </p>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden mb-6">
              <div className="p-6">
                ...
                {isImporting && (
                  <div className="mb-6">
                    <p className="font-medium text-gray-700 mb-2">Importing {getImportTypeName(selectedImportOption)}...</p>
                ...
                <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">You can also skip importing and start fresh</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700">
                    Check our <a href="#" className="underline font-medium">step-by-step guide</a> on 
                    how to export your health data from various providers and import it here.
                  </p>
                </div>
              </div>
            </div>
        ...
        {currentStep === 5 && (
          <div className="max-w-2xl mx-auto w-full">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                Last step! Choose which features you'd like to enable for your health data management.
              </p>
            </div>
            ...
            <div className="bg-green-50 border border-green-100 rounded-lg p-6 mb-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-medium text-green-800 mb-2">Ready to Take Control of Your Health Data</h4>
                  <p className="text-green-700">
                    You've successfully set up your Health Data Manager. Your selected preferences have been saved, and you 
                    can change any of these settings later in the application.
                  </p>
                </div>
              </div>
            </div>
